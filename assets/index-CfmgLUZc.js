...
`;var n=document.querySelector(`#mainSection`),r=document.querySelector(`#calculateBtn`),i=document.querySelector(`#numberInput`),a=document.querySelector(`#result`),o=document.querySelector(`#error`),s=document.querySelector(`#cancelBtn`);r.addEventListener(`click`,()=>{o.innerHTML=``;let n=i.value;try{t(n)}catch(e){o.innerHTML=e.message;return}a.innerHTML=e(n)}),s.addEventListener(`click`,()=>{n.innerHTML=`
